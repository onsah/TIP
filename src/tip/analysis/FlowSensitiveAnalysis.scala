...
/**
  ...
  */
abstract class FlowSensitiveAnalysis(val stateAfterNode: Boolean)
...
object FlowSensitiveAnalysis {
  ...
  def select(kind: Analysis.Value,
             ...
             cfg: FragmentCfg)(
      implicit declData: DeclarationData): Option[FlowSensitiveAnalysis] = {

    val typedCfg = options match {
      case AnalysisOption.`iwlr` | AnalysisOption.`iwlrp` |
          AnalysisOption.`csiwlrp` | AnalysisOption.`cfiwlrp` |
          AnalysisOption.`ide` | AnalysisOption.`summary` =>
        cfg match {
    ...
    options match {
      ...
      case AnalysisOption.`simple` =>
        Some(kind match {
          ...
          case Analysis.livevars =>
            new LiveVarsAnalysisSimpleSolver(typedCfg.left.get)
          case Analysis.available =>
            new AvailableExpAnalysisSimpleSolver(typedCfg.left.get)
          ...
          case Analysis.constprop =>
            new ConstantPropagationAnalysis.Intraprocedural.SimpleSolver(
              typedCfg.left.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
        })
      case AnalysisOption.`wl` =>
        Some(kind match {
          case Analysis.sign =>
            new SignAnalysis.Intraprocedural.WorklistSolver(typedCfg.left.get)
          case Analysis.livevars =>
            new LiveVarsAnalysisWorklistSolver(typedCfg.left.get)
          case Analysis.available =>
            new AvailableExpAnalysisWorklistSolver(typedCfg.left.get)
          ...
          case Analysis.constprop =>
            new ConstantPropagationAnalysis.Intraprocedural.WorklistSolver(
              typedCfg.left.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`wlr` =>
        Some(kind match {
          case Analysis.sign =>
            new SignAnalysis.Intraprocedural.WorklistSolverWithReachability(
              typedCfg.left.get)
          case Analysis.constprop =>
            new ConstantPropagationAnalysis.Intraprocedural.WorklistSolverWithReachability(
              typedCfg.left.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`wlrw` =>
        Some(kind match {
          case Analysis.interval =>
            new IntervalAnalysis.Intraprocedural.WorklistSolverWithWidening(
              typedCfg.left.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`wlrwn` =>
        Some(kind match {
          case Analysis.interval =>
            new IntervalAnalysis.Intraprocedural.WorklistSolverWithWideningAndNarrowing(
              typedCfg.left.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`wlrp` =>
        Some(kind match {
          case Analysis.sign =>
            new SignAnalysis.Intraprocedural.WorklistSolverWithReachabilityAndPropagation(
              typedCfg.left.get)
          case Analysis.constprop =>
            new ConstantPropagationAnalysis.Intraprocedural.WorklistSolverWithReachabilityAndPropagation(
              typedCfg.left.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`iwlr` =>
        Some(kind match {
          case Analysis.sign =>
            new SignAnalysis.Interprocedural.WorklistSolverWithReachability(
              typedCfg.right.get)
          case Analysis.constprop =>
            new ConstantPropagationAnalysis.Interprocedural.WorklistSolverWithReachability(
              typedCfg.right.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`iwlrp` =>
        Some(kind match {
          case Analysis.sign =>
            new SignAnalysis.Interprocedural.WorklistSolverWithReachabilityAndPropagation(
              typedCfg.right.get)
          case Analysis.constprop =>
            new ConstantPropagationAnalysis.Interprocedural.WorklistSolverWithReachabilityAndPropagation(
              typedCfg.right.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`csiwlrp` =>
        Some(kind match {
          case Analysis.sign =>
            new SignAnalysis.Interprocedural.CallString(typedCfg.right.get)
          case Analysis.constprop =>
            new ConstantPropagationAnalysis.Interprocedural.CallString(
              typedCfg.right.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`cfiwlrp` =>
        Some(kind match {
          case Analysis.sign =>
            new SignAnalysis.Interprocedural.Functional(typedCfg.right.get)
          case Analysis.constprop =>
            new ConstantPropagationAnalysis.Interprocedural.Functional(
              typedCfg.right.get)
          case _ =>
            throw new RuntimeException(
              s"Unsupported solver option `$options` for the analysis $kind")
      ...
      case AnalysisOption.`ide` =>
        Some(kind match {
          case Analysis.copyconstprop =>
            new CopyConstantPropagationIDEAnalysis(typedCfg.right.get)
          case Analysis.uninitvars =>
            new PossiblyUninitializedVarsIDEAnalysis(typedCfg.right.get)
      ...
      case AnalysisOption.`summary` =>
        Some(kind match {
          case Analysis.copyconstprop =>
            new CopyConstantPropagationSummaryAnalysis(typedCfg.right.get)
          case Analysis.uninitvars =>
            new PossiblyUninitializedVarsSummaryAnalysis(typedCfg.right.get)
  ...
  object AnalysisOption extends Enumeration {
    val simple, Disabled, wl, wlr, wlrw, wlrwn, wlrp, iwlr, iwlrp, csiwlrp,
    cfiwlrp, ide, summary = Value
  ...
  object Analysis extends Enumeration {
    val sign, livevars, available, vbusy, reaching, constprop, interval,
    copyconstprop, uninitvars, taint = Value
  }
}
